Enemy 를 수정하여 네크로멘서 , 좀비용 init 따로 만듬.
TutorialBoss 구현 , animation 적용 (die)
TODO : 시간남으면 해쉬받아서 애니메이션 적용시키기
...
/// </summary>  
    ...
    /// </summary>    public event Action<GameObject> onDeath;  
    ...
    /// <summary>    /// 오브젝트가 생성될 때(풀에서 꺼낼 때) 한 번 실행  
    /// </summary>  
    void Awake()  
    {        // 일단 일어나봐 메쉬야  
...
// NavMesh 위에 제대로 올라갔는지 체크  
    ...
    /// <summary>  
    /// 적이 죽었을 때 호출 (풀로 반환)  
    /// </summary>    protected virtual void Die()  
    {        isDead = true;  
        // NavMeshAgent 비활성화  
        agent.enabled = false;  
        OnDeath();  
